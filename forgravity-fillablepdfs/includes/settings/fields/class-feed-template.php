<?php
/**
 * Display Feed Template setting on feed settings page.
 *
 * @since   3.0
...
class Feed_Template extends Hidden {
	...
	public function localize_script() {
		...
		wp_localize_script(
			...
			'fg_fillablepdfs',
			[
				'api_base'      => fg_pdfs_api()->get_api_url(),
				'documentation' => [
					'duplicateFieldNames' => fg_fillablepdfs()->get_documentation_url( 'duplicate-field-names' ),
					'mappingCheckboxes'   => fg_fillablepdfs()->get_documentation_url( 'mapping-checkboxes' ),
					'mappingDropDowns'    => fg_fillablepdfs()->get_documentation_url( 'mapping-drop-downs' ),
					'mappingRadioButtons' => fg_fillablepdfs()->get_documentation_url( 'mapping-radio-buttons' ),
				],
