...
namespace {
    ...
    if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('Google_Client', \false)) {
        ...
        if (\defined('Google_Client::LIBVER') && \version_compare(\Google_Client::LIBVER, '2.7.2', '<=')) {
            $servicesClassMap = ['ForGravity\\Fillable_PDFs\\Google\\Client' => 'Google_Client', 'ForGravity\\Fillable_PDFs\\Google\\Service' => 'Google_Service', 'ForGravity\\Fillable_PDFs\\Google\\Service\\Resource' => 'Google_Service_Resource', 'ForGravity\\Fillable_PDFs\\Google\\Model' => 'Google_Model', 'ForGravity\\Fillable_PDFs\\Google\\Collection' => 'Google_Collection'];
