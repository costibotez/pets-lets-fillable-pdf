 ...
 * the License.
 */
namespace ForGravity\Fillable_PDFs\Google\Service\Drive\Resource;

use ForGravity\Fillable_PDFs\Google\Service\Drive\Channel;
use ForGravity\Fillable_PDFs\Google\Service\Drive\DriveFile;
use ForGravity\Fillable_PDFs\Google\Service\Drive\FileList;
use ForGravity\Fillable_PDFs\Google\Service\Drive\GeneratedIds;
use ForGravity\Fillable_PDFs\Google\Service\Drive\LabelList;
use ForGravity\Fillable_PDFs\Google\Service\Drive\ModifyLabelsRequest;
use ForGravity\Fillable_PDFs\Google\Service\Drive\ModifyLabelsResponse;
/**
 ...
 *  </code>
 */
class Files extends \ForGravity\Fillable_PDFs\Google\Service\Resource
{
    /**
