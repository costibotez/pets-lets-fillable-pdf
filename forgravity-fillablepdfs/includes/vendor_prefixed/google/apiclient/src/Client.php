 ...
 */
namespace ForGravity\Fillable_PDFs\Google;

use BadMethodCallException;
use DomainException;
use ForGravity\Fillable_PDFs\Google\AccessToken\Revoke;
use ForGravity\Fillable_PDFs\Google\AccessToken\Verify;
use ForGravity\Fillable_PDFs\Google\Auth\ApplicationDefaultCredentials;
use ForGravity\Fillable_PDFs\Google\Auth\Cache\MemoryCacheItemPool;
use ForGravity\Fillable_PDFs\Google\Auth\Credentials\ServiceAccountCredentials;
use ForGravity\Fillable_PDFs\Google\Auth\Credentials\UserRefreshCredentials;
use ForGravity\Fillable_PDFs\Google\Auth\CredentialsLoader;
use ForGravity\Fillable_PDFs\Google\Auth\FetchAuthTokenCache;
use ForGravity\Fillable_PDFs\Google\Auth\GetUniverseDomainInterface;
use ForGravity\Fillable_PDFs\Google\Auth\HttpHandler\HttpHandlerFactory;
use ForGravity\Fillable_PDFs\Google\Auth\OAuth2;
use ForGravity\Fillable_PDFs\Google\AuthHandler\AuthHandlerFactory;
use ForGravity\Fillable_PDFs\Google\Http\REST;
use ForGravity\Fillable_PDFs\GuzzleHttp\Client as GuzzleClient;
use ForGravity\Fillable_PDFs\GuzzleHttp\ClientInterface;
use ForGravity\Fillable_PDFs\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use ForGravity\Fillable_PDFs\Monolog\Handler\StreamHandler as MonologStreamHandler;
use ForGravity\Fillable_PDFs\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use ForGravity\Fillable_PDFs\Monolog\Logger;
use ForGravity\Fillable_PDFs\Psr\Cache\CacheItemPoolInterface;
use ForGravity\Fillable_PDFs\Psr\Http\Message\RequestInterface;
use ForGravity\Fillable_PDFs\Psr\Http\Message\ResponseInterface;
use ForGravity\Fillable_PDFs\Psr\Log\LoggerInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\ForGravity\\Fillable_PDFs\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\ForGravity\\Fillable_PDFs\\GuzzleHttp\\ClientInterface::VERSION')) {
