 ...
 */
namespace ForGravity\Fillable_PDFs\Google\Http;

use ForGravity\Fillable_PDFs\Google\Auth\HttpHandler\HttpHandlerFactory;
use ForGravity\Fillable_PDFs\Google\Service\Exception as GoogleServiceException;
use ForGravity\Fillable_PDFs\Google\Task\Runner;
...
use ForGravity\Fillable_PDFs\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('ForGravity\\Fillable_PDFs\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \ForGravity\Fillable_PDFs\GuzzleHttp\Message\ResponseInterface) {
