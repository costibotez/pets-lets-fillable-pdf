 ...
 */
use ForGravity\Fillable_PDFs\google\appengine\api\app_identity\AppIdentityService;
...
class AppIdentityCredentials extends CredentialsLoader implements SignBlobInterface, ProjectIdProviderInterface
{
    ...
    {
        if (!self::onAppEngine() || !\class_exists('ForGravity\\Fillable_PDFs\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
