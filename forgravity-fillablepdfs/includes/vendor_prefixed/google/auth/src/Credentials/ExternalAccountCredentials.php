 ...
 */
namespace ForGravity\Fillable_PDFs\Google\Auth\Credentials;

use ForGravity\Fillable_PDFs\Google\Auth\CredentialSource\AwsNativeSource;
use ForGravity\Fillable_PDFs\Google\Auth\CredentialSource\FileSource;
use ForGravity\Fillable_PDFs\Google\Auth\CredentialSource\UrlSource;
use ForGravity\Fillable_PDFs\Google\Auth\ExternalAccountCredentialSourceInterface;
use ForGravity\Fillable_PDFs\Google\Auth\FetchAuthTokenInterface;
use ForGravity\Fillable_PDFs\Google\Auth\GetQuotaProjectInterface;
...
use ForGravity\Fillable_PDFs\Google\Auth\ProjectIdProviderInterface;
use ForGravity\Fillable_PDFs\Google\Auth\UpdateMetadataInterface;
use ForGravity\Fillable_PDFs\Google\Auth\UpdateMetadataTrait;
