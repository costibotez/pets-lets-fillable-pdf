...
use ForGravity\Fillable_PDFs\Google\Auth\Credentials\ExternalAccountCredentials;
use ForGravity\Fillable_PDFs\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use ForGravity\Fillable_PDFs\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], ?callable $httpHandler = null, ?callable $tokenCallback = null)
    {
        ...
        $stack = \ForGravity\Fillable_PDFs\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \ForGravity\Fillable_PDFs\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
