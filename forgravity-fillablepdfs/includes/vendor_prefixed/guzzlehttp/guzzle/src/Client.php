...
use ForGravity\Fillable_PDFs\GuzzleHttp\Cookie\CookieJar;
use ForGravity\Fillable_PDFs\GuzzleHttp\Exception\GuzzleException;
use ForGravity\Fillable_PDFs\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \ForGravity\Fillable_PDFs\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
