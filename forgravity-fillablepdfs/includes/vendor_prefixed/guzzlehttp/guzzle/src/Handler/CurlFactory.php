...
namespace ForGravity\Fillable_PDFs\GuzzleHttp\Handler;

use ForGravity\Fillable_PDFs\GuzzleHttp\Exception\ConnectException;
use ForGravity\Fillable_PDFs\GuzzleHttp\Exception\RequestException;
use ForGravity\Fillable_PDFs\GuzzleHttp\Promise as P;
use ForGravity\Fillable_PDFs\GuzzleHttp\Promise\FulfilledPromise;
use ForGravity\Fillable_PDFs\GuzzleHttp\Promise\PromiseInterface;
use ForGravity\Fillable_PDFs\GuzzleHttp\Psr7\LazyOpenStream;
use ForGravity\Fillable_PDFs\GuzzleHttp\TransferStats;
use ForGravity\Fillable_PDFs\GuzzleHttp\Utils;
use ForGravity\Fillable_PDFs\Psr\Http\Message\RequestInterface;
use ForGravity\Fillable_PDFs\Psr\Http\Message\UriInterface;
/**
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx) : PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \ForGravity\Fillable_PDFs\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri) : string
    {
        ...
        $redactedUriString = \ForGravity\Fillable_PDFs\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \ForGravity\Fillable_PDFs\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \ForGravity\Fillable_PDFs\GuzzleHttp\Psr7\Utils::streamFor($sink);
