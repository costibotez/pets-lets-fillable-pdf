...
use ForGravity\Fillable_PDFs\GuzzleHttp\Cookie\CookieJarInterface;
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('ForGravity\\Fillable_PDFs\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
