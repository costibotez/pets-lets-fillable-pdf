 ...
 */
namespace ForGravity\Fillable_PDFs\Monolog\Handler;

use ForGravity\Fillable_PDFs\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use ForGravity\Fillable_PDFs\Monolog\Logger;
use ForGravity\Fillable_PDFs\Monolog\Formatter\FormatterInterface;
use ForGravity\Fillable_PDFs\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use ForGravity\Fillable_PDFs\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use ForGravity\Fillable_PDFs\Elasticsearch\Client;
use ForGravity\Fillable_PDFs\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use ForGravity\Fillable_PDFs\Elastic\Elasticsearch\Client as Client8;
/**
