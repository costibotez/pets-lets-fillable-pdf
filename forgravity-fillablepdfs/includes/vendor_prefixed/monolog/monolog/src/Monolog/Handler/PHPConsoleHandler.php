...
use ForGravity\Fillable_PDFs\Monolog\Formatter\LineFormatter;
use ForGravity\Fillable_PDFs\Monolog\Formatter\FormatterInterface;
use ForGravity\Fillable_PDFs\Monolog\Logger;
use ForGravity\Fillable_PDFs\Monolog\Utils;
use ForGravity\Fillable_PDFs\PhpConsole\Connector;
use ForGravity\Fillable_PDFs\PhpConsole\Handler as VendorPhpConsoleHandler;
use ForGravity\Fillable_PDFs\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('ForGravity\\Fillable_PDFs\\PhpConsole\\Connector')) {
