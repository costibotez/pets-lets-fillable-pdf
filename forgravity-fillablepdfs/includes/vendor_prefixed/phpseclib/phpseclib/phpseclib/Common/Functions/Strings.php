 ...
 */
namespace ForGravity\Fillable_PDFs\phpseclib3\Common\Functions;

use ForGravity\Fillable_PDFs\ParagonIE\ConstantTime\Base64;
use ForGravity\Fillable_PDFs\ParagonIE\ConstantTime\Base64UrlSafe;
use ForGravity\Fillable_PDFs\ParagonIE\ConstantTime\Hex;
use ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger;
use ForGravity\Fillable_PDFs\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
