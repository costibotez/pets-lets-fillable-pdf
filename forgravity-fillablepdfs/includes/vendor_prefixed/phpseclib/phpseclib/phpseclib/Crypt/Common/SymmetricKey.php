 ...
 */
namespace ForGravity\Fillable_PDFs\phpseclib3\Crypt\Common;
...
use ForGravity\Fillable_PDFs\phpseclib3\Exception\BadDecryptionException;
use ForGravity\Fillable_PDFs\phpseclib3\Exception\BadModeException;
use ForGravity\Fillable_PDFs\phpseclib3\Exception\InconsistentSetupException;
...
use ForGravity\Fillable_PDFs\phpseclib3\Math\BinaryField;
use ForGravity\Fillable_PDFs\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
