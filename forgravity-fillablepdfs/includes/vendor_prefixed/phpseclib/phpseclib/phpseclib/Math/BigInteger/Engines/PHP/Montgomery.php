 ...
 */
namespace ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\PHP;

use ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\Engine;
use ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\PHP;
use ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
