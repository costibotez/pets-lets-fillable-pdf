 ...
 */
namespace ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\PHP;
use ForGravity\Fillable_PDFs\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
