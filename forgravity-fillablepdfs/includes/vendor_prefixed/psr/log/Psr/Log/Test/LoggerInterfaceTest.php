...
namespace ForGravity\Fillable_PDFs\Psr\Log\Test;

use ForGravity\Fillable_PDFs\Psr\Log\LoggerInterface;
use ForGravity\Fillable_PDFs\Psr\Log\LogLevel;
use ForGravity\Fillable_PDFs\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('ForGravity\\Fillable_PDFs\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('ForGravity\\Fillable_PDFs\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('ForGravity\\Fillable_PDFs\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
